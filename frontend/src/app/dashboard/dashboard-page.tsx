      ...
      <div className="max-w-5xl mx-auto p-6">
        ...
        >
          <div className="flex items-center justify-between px-6 py-5">
            <div>
              <div className="text-xs tracking-widest mb-1" style={{ color: '#9A8A7A', fontFamily: 'Georgia, serif' }}>
                TODAY'S EDITION
              </div>
              <h3 className="font-bold italic text-2xl" style={{ color: '#1F1B16', fontFamily: 'Georgia, serif' }}>
                The Aspirant's Daily
              </h3>
              <p className="text-sm mt-1" style={{ color: '#6B6258', fontFamily: 'Georgia, serif' }}>
                Editorials · Current Affairs · Key Facts · Word of the Day
              </p>
            </div>
            <div className="text-right">
              <div className="text-3xl mb-1">📰</div>
              <div className="text-xs font-semibold px-3 py-1 rounded-full" style={{ background: '#9A7A2E', color: '#F7F4ED', fontFamily: '-apple-system, sans-serif' }}>
                Read Now →
              </div>
            </div>
          </div>
