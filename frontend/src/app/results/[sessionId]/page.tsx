        ...
        <div style={{ display: 'flex', gap: 8, marginBottom: 16 }}>
          {([
            ...
            <button key={t.id}
              ...
              style={{ flex: 1, padding: '10px 0', borderRadius: 12, fontWeight: 600, fontSize: 13, cursor: 'pointer', border: tab === t.id ? 'none' : '1.5px solid #e2e8f0', background: tab === t.id ? '#2563eb' : '#fff', color: tab === t.id ? '#fff' : '#475569' }}>
              {t.label}
            </button>
          ))}
        </div>
